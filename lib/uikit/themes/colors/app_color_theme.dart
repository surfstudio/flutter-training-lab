...
class AppColorTheme extends ThemeExtension<AppColorTheme> {
  ...
  final Color bottomNavigationBarActiveIcon;
  ...
  const AppColorTheme._({
    ...
    required this.bottomNavigationBarActiveIcon,
  });
  ...
  const AppColorTheme.dark()
    : scaffold = AppColors.colorBlackMain,
      ...
      bottomNavigationBarIcon = AppColors.colorWhite,
      bottomNavigationBarActiveIcon = AppColors.colorWhite;
  ...
  const AppColorTheme.light()
    : scaffold = AppColors.colorWhite,
      ...
      textSecondaryVariant = AppColors.colorSecondary2,
      textInactive = AppColors.colorInactiveBlack,
      bottomNavigationBarIcon = AppColors.colorWhiteMain,
      bottomNavigationBarActiveIcon = AppColors.colorWhiteMain;
  ...
  ThemeExtension<AppColorTheme> copyWith({
    ...
    Color? bottomNavigationBarActiveIcon,
  }) {
    return AppColorTheme._(
      ...
      bottomNavigationBarActiveIcon: bottomNavigationBarActiveIcon ?? this.bottomNavigationBarActiveIcon,
    );
  }
  ...
  ThemeExtension<AppColorTheme> lerp(ThemeExtension<AppColorTheme>? other, double t) {
    ...
    return AppColorTheme._(
      ...
      bottomNavigationBarActiveIcon: Color.lerp(bottomNavigationBarActiveIcon, other.bottomNavigationBarActiveIcon, t)!,
    );
  }
}
