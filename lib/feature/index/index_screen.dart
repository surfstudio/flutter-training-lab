      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            FilledButton(
              onPressed: () {
                unawaited(Navigator.of(context).push(MaterialPageRoute(builder: (_) => SettingsScreenBuilder())));
              },
            ...
            FilledButton(
              onPressed: () {
                unawaited(Navigator.of(context).push(MaterialPageRoute(builder: (_) => FavoritesScreenBuilder())));
              },
